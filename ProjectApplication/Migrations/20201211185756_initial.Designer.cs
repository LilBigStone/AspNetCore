...
namespace ProjectApplication.Migrations
{
    ...
    [Migration("20201211185756_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectApplication.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<int>("MilkProdId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectApplication.Data.Models.OrderDetail", b =>
                {
                    b.HasOne("ProjectApplication.Data.Models.MilkProd", "milk")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectApplication.Models.Comment", b =>
                {
                    b.HasOne("ProjectApplication.Data.Models.MilkProd", "MilkProd")
                        .WithMany()
                        .HasForeignKey("MilkProdId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
